...
#define neon_cbd_eta1 KYBER_NAMESPACE(_neon_cbd_eta1)
void neon_cbd_eta1(poly *r, const uint8_t buf[KYBER_ETA1*KYBER_N/4]);

#define neon_cbd_eta2 KYBER_NAMESPACE(_neon_cbd_eta2)
void neon_cbd_eta2(poly *r, const uint8_t buf[KYBER_ETA2*KYBER_N/4]);
