...
#define kyber_aes256xof_absorb KYBER_NAMESPACE(_ref_kyber_aes256xof_absorb)
void kyber_aes256xof_absorb(aes256ctr_ctx *state,
                            const uint8_t seed[KYBER_SYMBYTES],
                            uint8_t x,
                            uint8_t y);

#define kyber_aes256ctr_prf KYBER_NAMESPACE(_ref_kyber_aes256ctr_prf)
...
#define kyber_shake128_absorb KYBER_NAMESPACE(_ref_kyber_shake128_absorb)
void kyber_shake128_absorb(keccak_state *s,
                           const uint8_t seed[KYBER_SYMBYTES],
                           uint8_t x,
                           uint8_t y);

#define kyber_shake256_prf KYBER_NAMESPACE(_ref_kyber_shake256_prf)
